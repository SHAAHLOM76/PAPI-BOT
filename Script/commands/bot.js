...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Shaahlom") || (event.body.toLowerCase() == "shaahlom bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Shaahlom❤️ হাই আমি মেছেন্জার ROBOT  আামার বস ⃝—͟͟͞͞ 𝐂.𝐄.𝐎⸙𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌𓆪___//🩷 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "বলভি") || (event.body.toLowerCase() == "Alvi")) {
     return api.sendMessage("🥰-আলভি🌺 আমার বস ⃝—͟͟͞͞ 𝐂.𝐄.𝐎⸙𝐒𝐇𝐀𝐀𝐇𝐋𝐎𝐌𓆪___//🩷'র বন্ধু  লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
